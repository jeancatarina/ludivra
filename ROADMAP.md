...
| Próxima entrega | Implementar salas loopback host-authoritative, protocolo N/N-1 e snapshots verificáveis antes dos adapters de rede. |
...
| 7 | Persistência, replays e multiplayer player-hosted | `EM ANDAMENTO` | Salas host-authoritative, transport adapters, late join, reconexão e host migration. |
