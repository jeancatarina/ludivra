...
- Manifest v5 declara environments core/enhanced por target com sky, exposição, fog, luzes e perfil de sombra; BrowserHost aplica o environment antes do primeiro frame, recusa tier enhanced em web-compatible e o smoke Electron registra o tier efetivo. Capabilities: `presentation.render-environments`. Evidência: [schemas/game.schema.json](schemas/game.schema.json), [renderer-three/src/environment.ts](renderer-three/src/environment.ts), [renderer-three/src/index.ts](renderer-three/src/index.ts), [hosts/browser/src/main.ts](hosts/browser/src/main.ts), [hosts/electron/src/main.cjs](hosts/electron/src/main.cjs), [examples/first-game/game.jsonc](examples/first-game/game.jsonc), [examples/card-roguelite/game.jsonc](examples/card-roguelite/game.jsonc).
...
- Modelos semânticos de material, texturas por papel, shader warmup/cache e fallback verificável.
