...
| ENG-004 | alta | planejado | Automatizar todas as regras de imports e ciclos |
| ENG-005 | alta | planejado | Produzir artifact manifest por execução da CLI |
...
| ENG-011 | alta | planejado | Reconciliar `PROJECT_STATE.json` com o estado canônico definido pela arquitetura |
