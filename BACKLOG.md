...
|---|---|---|---|
| ENG-001 | alta | próximo | Fixar Lua e implementar sandbox mínima |
| ENG-002 | alta | próximo | Instalar Emscripten e provar equivalência native/WASM |
| ENG-003 | alta | planejado | Adicionar validação JSON Schema completa sem duplicar contratos |
