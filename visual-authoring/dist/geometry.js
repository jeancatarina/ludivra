...
export function buildSkeleton(spec, style) {
    ...
    const leftElbow = [-shoulderHalf - upperArm * 0.78, shoulderY - upperArm * 0.62, leftDrift];
    const rightElbow = [shoulderHalf + upperArm * 0.78, shoulderY - upperArm * 0.62, rightDrift];
    const leftWrist = [leftElbow[0] - lowerArm * 0.25, leftElbow[1] - lowerArm * 0.97, leftDrift];
    const rightWrist = [rightElbow[0] + lowerArm * 0.25, rightElbow[1] - lowerArm * 0.97, rightDrift];
