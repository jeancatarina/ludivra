...
const families: FamilyDefinition[] = [
  ...
  },
  {
    ...
    inputs: [
      ...
      "presentation-protocol/package.json",
      "presentation-protocol/tsconfig.json",
      "platform-contracts/src",
      "platform-contracts/package.json",
      ...
      "runtime-web/tsconfig.json",
      "renderer-three/src",
      "renderer-three/package.json",
      "renderer-three/tsconfig.json",
      "package.json",
      "pnpm-lock.yaml"
    ],
    outputs: [
