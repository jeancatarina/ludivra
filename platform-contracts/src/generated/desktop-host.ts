...
export type DesktopServiceId = "storage.local" | "diagnostics.crash" | "diagnostics.logs" | "steam.achievements" | "steam.cloud" | "steam.networking" | "steam.overlay" | "steam.user" | "updates.desktop";
