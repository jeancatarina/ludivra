...
- Substituído em parte: a ponte `composeGameplaySource` foi removida quando o content pack do [ADR 0017](0017-content-pack-compilation-and-migrations.md) passou a carregar em todos os hosts; a autoridade única do JSONC permanece válida
