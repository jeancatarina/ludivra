...
O vínculo desse boundary ao Runtime, Lua e adapter Web permanece uma entrega posterior da Fase 7; a existência do arquivo não concede persistência mundial automaticamente a um jogo.
